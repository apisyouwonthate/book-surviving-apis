...
The "happy path" is the way things should work in an ideal world, where nothing goes wrong.

The happy path for an API interaction is pretty simple. 

.The most basic API interaction possible.
[source,javascript]
----
const url = 'https://api.protect.earth/maps/sites/a40d4174-f8c6-486a-adff-69364e0c1d18';
fetch(url)
