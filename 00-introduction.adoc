...
subset of functionality or data that an application owns. The interactionsover
...
EmberJS/ReactJS offering data-binding to pull and push data from a data source.
